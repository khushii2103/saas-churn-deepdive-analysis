...
<p align="center">
  <b>SQL + Python | Telco Customer Churn Dataset — Kaggle (IBM) | Project 3</b><br>
...
<p align="center">
  <img src="https://img.shields.io/badge/SQL-SQLite-blue?logo=sqlite&logoColor=white" />
...
> All charts and results are produced from the cleaned Telco dataset using Python (matplotlib / seaborn) and SQL (SQLite).

### Churn Heatmap — Tenure × Contract Type
![Churn heatmap](outputs/churn_heatmap_tenure_contract.png)

### KDE Plot — Monthly Charges: Churned vs Retained
![KDE charges](outputs/kde_monthly_charges.png)

### Survival-Style Chart — Churn Rate by Segment Over Tenure
![Survival chart](outputs/survival_chart_by_segment.png)

### ARPU — Churned vs Retained Customers
![ARPU comparison](outputs/arpu_churned_vs_retained.png)

### 12-Month Revenue Projection — Current vs 2% Reduced Churn
![Revenue projection](outputs/revenue_projection_12m.png)
...
The cleaned CSV was loaded into SQLite via Python's `sqlite3`. SQL queries segmented churn by contract type, tenure bucket (0–6, 7–12, 13–24, 24+ months), and monthly charge range. ARPU was calculated separately for churned and retained groups.

**Step 2 — Pull results into Python**
`SQLAlchemy` was used to connect the SQLite database to pandas. SQL result-sets became DataFrames for further analysis and visualisation — a standard data engineering pattern for analyst workflows.
...
|---|---|
| **SQLite + sqlite3** | Database storage and churn segmentation queries |
| **SQLAlchemy** | Connecting Python to SQLite — industry standard ORM pattern |
...
| Section | Focus |
|---|---|
| **1. Setup & Data Loading** | SQLite DB creation, CSV load via pandas + SQLAlchemy |
...
🔗 [GitHub](https://github.com/khushii2103) &nbsp;|&nbsp; 📂 [Dataset on Kaggle](https://www.kaggle.com/datasets/blastchar/telco-customer-churn) &nbsp;|&nbsp; 📊 [Project 1 — Order & Revenue Analysis](https://github.com/khushii2103/ecommerce-sql-analysis)
